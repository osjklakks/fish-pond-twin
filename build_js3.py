...
add('  renderTwinSensors();')
add('  window.addEventListener("resize",function(){doChart.resize();radarChart.resize();barChart.resize();multiChart.resize();robotChart.resize();});')
add('  window._charts={doChart:doChart,radarChart:radarChart,barChart:barChart,multiChart:multiChart,robotChart:robotChart};')
add('}')

with open(OUT, 'a', encoding='utf-8') as f:
    f.write('\n'.join(js))
print('JS Part 3 ECharts written. Total:', os.path.getsize(OUT), 'bytes')
